...
if(!grabbed && !placed){
	...
	show_debug_message(string(ingredient_json));
	...
	show_debug_message(string(inventory_obj.complex_ingredients[? ingredient_name]))
	show_debug_message("2.")
	var ingredient_json = json_encode(inventory_obj.complex_ingredients);
	show_debug_message(string(ingredient_json));
	show_debug_message("3.")
	var ingredient_json = json_encode(player_obj.inventory.complex_ingredients)
	show_debug_message(string(ingredient_json));
