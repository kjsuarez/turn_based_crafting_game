...
if(transitioning){
	...
	if(transition_dir == -1){
		...
		draw_sprite_part(sprite_index, image_index, 0, 0, sprite_width - new_sprite_width, sprite_height, x + new_sprite_width, y );
		draw_sprite_part(next_sprite, -1, current_sprite_width, 0, sprite_width, sprite_height, x, y );
	} else {
